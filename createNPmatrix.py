...
for measid in measIDs:
    ...
    pathr = path + measid + '/'
    path_save = '/home/jan/Documents/dros/new_data/aligned/' + dataset + '_' + measid #+ measid + '/unnormed_nnma' + str(variance) + '/'#'percent' + str(variance).split('.')[1] + '/'
