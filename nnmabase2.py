...
loader = sb.DBnpyLoader(data_selection, path)
timeseries = loader()
...
highpass = bf.Filter(filters.median_filter, {'size':15}, downscale=2)
bandpass = bf.Combine(np.subtract)
nma = sb.NNMA(latents=81, maxcount=70, nma_param)
