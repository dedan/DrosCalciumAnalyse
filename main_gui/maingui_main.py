...
class MainGui(QtGui.QMainWindow, Ui_MainGuiWin):
    ...
    def load_controls(self):
        ...
        self.spars_par1_spinner.setValue(config['methods']['nnma']['sparse_par1'])
        self.spars_par2_spinner.setValue(config['methods']['nnma']['sparse_par2'])
    ...
    def save_controls(self, export_file=''):
        ...
        config['methods']['nnma']['sparse_par1'] = self.spars_par1_spinner.value()
        config['methods']['nnma']['sparse_par2'] = self.spars_par2_spinner.value()
