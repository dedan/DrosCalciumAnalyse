...
class MainGui(QtGui.QMainWindow, Ui_MainGuiWin):
    ...
    def load_controls(self):
        ...
        self.raw_overview_box.setChecked(config['sorted overview'])
        self.raw_unsort_overview_box.setChecked(config['unsorted overview'])
    ...
    def save_controls(self, export_file=''):
        ...
        config['sorted overview'] = self.raw_overview_box.isChecked()
        config['unsorted overview'] = self.raw_unsort_overview_box.isChecked()
